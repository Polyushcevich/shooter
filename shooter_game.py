...
def respawn_enemy():
    monster = Enemy("ufo.png", randint(20, w-100), -50,80,50,randint(1,3))
...
def menu():
    ...
    while menu:
        ...
        mw.blit(text_play, ((w/2)-130,150))
        mw.blit(text_exit, ((w/2)-150,200))
        display.update()
        ...
        if not finish:
            ...
            if rel_time:
                ...
                if now_time - last_time <3:
                    reload = text1.render("Wait, reloading...",1,(127,211,123),(223,65,35))
                    mw.blit(reload,(w//2-50, h-50))
                else:
                    num_fire=0
                    rel_time=False

            text_killed = text1.render("Рахунок" + str(killed), 1,(255,0,0))
            mw.blit(text_killed, (20,20))

            text_lost = text1.render("Пропущено:"+str(score),1,(135,145,240),(255,255,255))
